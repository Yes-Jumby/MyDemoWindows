...
void CClientDlg::OnTimer(UINT_PTR nIDEvent)
{
  ...
  */
    ...
    fprintf(file0, "%s\t%X\t%d:%d:%dT%d:%d:%d:%d\n",Close[0],Open[0],utm0.wYear,utm0.wMonth,utm0.wDay,utm0.wHour,utm0.wMinute,utm0.wSecond,utm0.wMilliseconds);
	fclose(file0);
	num++;
	}
