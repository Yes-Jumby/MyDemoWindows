...
bool CImageExWnd::IsImageCentered() const
{
   return m_viewportWnd.IsImageCentered();
}
...
bool CImageExWnd::IsPixelStringFormatDecimal() const
{
   return m_viewportWnd.IsPixelStringFormatDecimal();
}
