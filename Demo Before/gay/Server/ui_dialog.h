...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        pushButton->setGeometry(QRect(260, 290, 75, 23));
        lineEdit = new QLineEdit(Dialog);
        lineEdit->setObjectName(QStringLiteral("lineEdit"));
        lineEdit->setGeometry(QRect(80, 290, 113, 20));
        Prog = new QProgressBar(Dialog);
        Prog->setObjectName(QStringLiteral("Prog"));
        Prog->setGeometry(QRect(370, 150, 311, 23));
        Prog->setValue(24);
        selectBtn = new QPushButton(Dialog);
        selectBtn->setObjectName(QStringLiteral("selectBtn"));
        selectBtn->setGeometry(QRect(90, 340, 75, 23));
        Test = new QPushButton(Dialog);
        Test->setObjectName(QStringLiteral("Test"));
        Test->setGeometry(QRect(430, 280, 75, 23));
        groupBox->raise();
        label_2->raise();
        linePORT->raise();
        textEdit->raise();
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        listenBtn->setText(QApplication::translate("Dialog", "\344\276\246\345\220\254", Q_NULLPTR));
        ...
        Test->setText(QApplication::translate("Dialog", "\346\265\213\350\257\225", Q_NULLPTR));
    } // retranslateUi
