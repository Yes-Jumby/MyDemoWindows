...
public:
    ...
    bool PutPhoneOnAxis();
    bool Path_Lisener();//听筒
    bool Path_Frame_1();
    bool Path_Frame_2();
    bool Path_Frame_3();
    bool Path_Frame_4();
    bool Path_FrameCorner_1();
    bool Path_FrameCorner_2();
    bool Path_FrameCorner_3();
    bool Path_FrameCorner_4();
    bool Path_CylinderCamera();
    bool Path_Cylinder();
    bool Path_CameraFocus();
    bool Path_Flash();
    bool Path_Back();
    bool PutPhoneOut();
    bool Path_Move(int iAxis_X, int iAxis_Y, int iAxis_Z,int iVel,int iAcc);
...
private:
    ...
    int m_W_H;
    float  m_fExposureTimeOld[6];//摄像头、中框上、中框下面阵、新加相机
    float m_fGainOld[6];
