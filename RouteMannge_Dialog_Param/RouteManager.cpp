...
bool CRouteManager::IPhonePath_4()//背面检测
{
    ...
    {
        flag = m_MotionCard.CoordinateLineMove(1,m_iFlashOffSetX,m_iFlashOffSetY,m_iFlashOffSetZ - 4 * m_iCircle14,m_iBackVel,m_iBackAcc);
        flag = m_MotionCard.CoordinateBufDelay(1,200);//延迟1s
...
bool CRouteManager::PutPhoneOnAxis()
{
    m_bIsThreadContinueRun = true;
    if (m_bIsThreadContinueRun)
    {
    ...
    bool flag;
    //走到正面检测
    flag = m_MotionCard.CoordinateLineMove(1, m_iP1, -4016 + m_iFrontOffSetY, m_iFrontOffSetZ, m_iFrontVel, m_iFrontAcc);
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
}

bool CRouteManager::Path_Back()
{
    bool flag;
    //走到反面检测
    flag = m_MotionCard.CoordinateLineMove(1, m_iP1, -3696 + m_iBackOffSetY, m_iBackOffSetZ - 4 * m_iCircle14, m_iBackVel, m_iBackAcc);
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
}
bool CRouteManager::PutPhoneOut()
{
    if (m_bIsThreadContinueRun)
    {
    ...
    //走到取点
    m_MotionCard.CoordinateLineMove(1, m_iP5 + m_iGetPointOffSetX, m_iGetPointOffSetY, m_iGetPointOffSetZ - 4 * m_iCircle14, m_iFrameVel, m_iLineAcc);//夹点需要实际验证
    m_MotionCard.CoordinateStart(1);
    m_MotionCard.CoordinateMoved(1);
...
bool CRouteManager::Path_Move(int iAxis_X, int iAxis_Y, int iAxis_Z,int iVel,int iAcc)
{
    bool flag;
    flag = m_MotionCard.CoordinateLineMove(1, iAxis_X, iAxis_Y, iAxis_Z, iVel, iAcc);
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
}
bool CRouteManager::Path_Frame_1()
{
    bool flag;
    //第一边---准备位置---m_iPublicLong+3*m_iFrameStep=150800+27000=177800-162000
    flag = m_MotionCard.CoordinateLineMove(1, m_iP3 - (m_iPublicLong / 2 + m_iFrameStep) + m_iFrameOffSetX1, m_MyLength - m_iWidth / 2 + m_iFrameOffSetY1, m_iFrameOffSetZ1, m_iFrameVel, m_iFrameAcc);
    //开始运动
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
}
bool CRouteManager::Path_Frame_2()
{
    bool flag;
    //第二边---准备位置---m_iPublicWidth+m_iFrameStep=75500+9000=84500---72000
    flag = m_MotionCard.CoordinateLineMove(1, m_iP3 - (m_iPublicWidth / 2 + m_iFrameStep) + 3600 + m_iFrameOffSetX2, m_MyLength - m_iLong / 2 + m_iFrameOffSetY2, m_iFrameOffSetZ2 - m_iCircle14, m_iFrameVel, m_iFrameAcc);
    //开始运动
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
}
bool CRouteManager::Path_Frame_3()
{
    bool flag;
    //第三边---准备位置---m_iPublicLong+3*m_iFrameStep=150800+27000=177800
    flag = m_MotionCard.CoordinateLineMove(1, m_iP3 - (m_iPublicLong / 2 + m_iFrameStep) + m_iFrameOffSetX3, m_MyLength - m_iWidth / 2 + m_iFrameOffSetY3, m_iFrameOffSetZ3 - 2 * m_iCircle14, m_iFrameVel, m_iFrameAcc);
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
}
bool CRouteManager::Path_Frame_4()
{
    bool flag;
    //第四边---准备位置---m_iPublicWidth+m_iFrameStep=75500+9000=84500
    flag = m_MotionCard.CoordinateLineMove(1, m_iP3 - (m_iPublicWidth / 2 + m_iFrameStep) + 3600 + m_iFrameOffSetX4, m_MyLength - m_iLong / 2 + m_iFrameOffSetY4, m_iFrameOffSetZ4 - 3 * m_iCircle14, m_iFrameVel, m_iFrameAcc);
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
}
bool CRouteManager::Path_FrameCorner_1()
{
    bool flag;
    //第一个R角
    flag = m_MotionCard.CoordinateLineMove(1, m_iFrameCornerOffSetX1, m_iFrameCornerOffSetY1, -m_iCircle14 / 2 + m_iFrameCornerOffSetZ1, m_iFrameCornerVel, m_iFrameCornerAcc);
...
bool CRouteManager::Path_FrameCorner_2()
{
    bool flag;
    //第二个R角20000+2610
    flag = m_MotionCard.CoordinateLineMove(1, m_iFrameCornerOffSetX2, m_iFrameCornerOffSetY2, -m_iCircle14 - m_iCircle14 / 2 + m_iFrameCornerOffSetZ2, m_iFrameCornerVel, m_iFrameCornerAcc);
...
bool CRouteManager::Path_FrameCorner_3()
{
    bool flag;
    //第三个R角
    flag = m_MotionCard.CoordinateLineMove(1, m_iFrameCornerOffSetX3, m_iFrameCornerOffSetY3, -2 * m_iCircle14 - m_iCircle14 / 2 + m_iFrameCornerOffSetZ3, m_iFrameCornerVel, m_iFrameCornerAcc);
...
bool CRouteManager::Path_FrameCorner_4()
{
    bool flag;
    //第四个R角
    flag = m_MotionCard.CoordinateLineMove(1, m_iFrameCornerOffSetX4, m_iFrameCornerOffSetY4, -3 * m_iCircle14 - m_iCircle14 / 2 + m_iFrameCornerOffSetZ4, m_iFrameCornerVel, m_iFrameCornerAcc);
...
bool CRouteManager::Path_CylinderCamera()//前置听筒
{
    bool flag;
    ///////前置听筒///////
    flag = m_MotionCard.CoordinateLineMove(1, m_iCylinderCameraX, m_iCylinderCameraY, m_iCylinderCameraZ, m_iUpDownCameraVel, m_iUpDownCameraAcc);
    flag = m_MotionCard.CoordinateBufDelay(1, 10);//延迟10ms
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
}
bool CRouteManager::Path_Cylinder()
{
    bool flag;
    if (!CylinderReady())
    {
...
bool CRouteManager::Path_CameraFocus()
{
    bool flag;
    ////////翻转//////
    //判断真空吸有产品
    ...
    ///////摄像头///////
    flag = m_MotionCard.CoordinateBufDelay(1, 200);//延迟1s
    flag = m_MotionCard.CoordinateLineMove(1, m_iP2 - m_iLong / 2 + 10 * m_iLightOpen + m_iCameraOffSetX, m_iCameraOffSetY / 2, m_iCameraOffSetZ - 4 * m_iCircle14, m_iUpDownCameraVel, m_iUpDownCameraAcc);
    flag = m_MotionCard.CoordinateLineMove(1, m_iP2 - m_iLong / 2 + m_iLightOpen + 7484 + m_iCameraOffSetX, m_iCameraOffSetY, m_iCameraOffSetZ - 4 * m_iCircle14, m_iUpDownCameraVel, m_iUpDownCameraAcc);
    flag = m_MotionCard.CoordinateBufDelay(1, 200);//延迟1s
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
...
bool CRouteManager::Path_Lisener()//听筒
{
    bool flag;
    //Lisener
    ///////Lisener///////
...
bool CRouteManager::Path_Flash()//听筒
{
    bool flag;
    //Lisener
    ///////闪光灯///////
    flag = m_MotionCard.CoordinateLineMove(1, m_iFlashOffSetX, m_iFlashOffSetY, m_iFlashOffSetZ - 4 * m_iCircle14, m_iFrontVel, m_iFrontAcc);
    flag = m_MotionCard.CoordinateStart(1);
    flag = m_MotionCard.CoordinateMovedForXR(1);
    return flag;
}
