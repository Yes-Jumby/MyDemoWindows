    ...
    ui(new Ui::CreatEvent)
{
    ...
    connect(this,&CreatEvent::signalSentMessageInfomation,this,&CreatEvent::slotGetMessageInfomation,Qt::BlockingQueuedConnection);
}
...
void CreatEvent::on_pushButton_StartThread_clicked()
{
    QFuture<void> future = QtConcurrent::run(this, &CreatEvent::FunNewThread);
}
void CreatEvent::FunNewThread()
{
    //QMessageBox::information(0,"警告","strAlarm");
    emit signalSentMessageInfomation("你好啊！");
}
void CreatEvent::slotGetMessageInfomation(QString strAlarm)
{
    QMessageBox::information(0,"警告",strAlarm);
}
